...
public class ProdutoPagamento {
    public static void main(String[] args) {
        ...
        Produto prod1 = new Produto(scanner.nextLine(),"D", scanner.nextDouble(), scanner.nextInt());            
        ...
        }else if (prod1.getPagamento() == "D" && valorTotal>100) {
            double valorD100 = valorTotal *0.97;
            System.out.println("Valor final e: "+ valorD100);
        }
